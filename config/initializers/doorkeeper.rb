Doorkeeper.configure do
  ...
  # This is needed as we have an api only controller which does not have
  # protect_from_forgery
  base_controller 'CustomDoorkeeperController'
...
Doorkeeper::JWT.configure do
  ...
  # {
  #   :resource_owner_id=>1,
  #   :scopes=>#<Doorkeeper::OAuth::Scopes:0x0000000004e33970 @scopes=[]>,
  #   :application=>#<Doorkeeper::Application id: 1, name: "Test Client", uid: "b", secret: "a", redirect_uri: "urn:ietf:wg:oauth:2.0:oob", scopes: "", confidential: true, created_at: "2018-07-23 14:29:36", updated_at: "2018-07-23 15:15:09">,
  #   :expires_in=>7200,
  #   :created_at=>Mon, 23 Jul 2018 15:20:00 UTC +00:00
  #  }
